-- ============================================
-- SUPABASE : Définir buron.alex17@gmail.com comme intervenant
-- ============================================
...
SELECT
  ...
  'intervenant' as role
FROM auth.users au
WHERE au.email = 'buron.alex17@gmail.com'
...
WHERE email = 'buron.alex17@gmail.com';

-- Vérifier le résultat
SELECT id, email, full_name, role FROM public.users WHERE email = 'buron.alex17@gmail.com';
