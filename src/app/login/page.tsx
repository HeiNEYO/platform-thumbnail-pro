...
// Positions et rotations pour le pattern Louis Vuitton (valeurs fixes pour éviter hydration mismatch)
const LOGO_PATTERN = [
  { x: "2%", y: "4%", size: 56, rotate: -12 },
  { x: "18%", y: "8%", size: 72, rotate: 8 },
  { x: "35%", y: "2%", size: 48, rotate: -25 },
  { x: "52%", y: "6%", size: 64, rotate: 15 },
  { x: "72%", y: "3%", size: 52, rotate: -8 },
  { x: "88%", y: "10%", size: 44, rotate: 22 },
  { x: "5%", y: "22%", size: 80, rotate: 18 },
  { x: "28%", y: "28%", size: 56, rotate: -18 },
  { x: "48%", y: "24%", size: 68, rotate: 5 },
  { x: "68%", y: "26%", size: 60, rotate: -30 },
  { x: "92%", y: "30%", size: 48, rotate: 12 },
  { x: "8%", y: "42%", size: 64, rotate: -15 },
  { x: "32%", y: "48%", size: 76, rotate: 20 },
  { x: "55%", y: "44%", size: 52, rotate: -22 },
  { x: "78%", y: "46%", size: 72, rotate: 8 },
  { x: "15%", y: "62%", size: 48, rotate: -10 },
  { x: "42%", y: "66%", size: 84, rotate: 25 },
  { x: "65%", y: "60%", size: 56, rotate: -18 },
  { x: "90%", y: "64%", size: 60, rotate: 12 },
  { x: "3%", y: "78%", size: 72, rotate: -20 },
  { x: "25%", y: "82%", size: 52, rotate: 15 },
  { x: "50%", y: "76%", size: 68, rotate: -12 },
  { x: "75%", y: "80%", size: 56, rotate: 18 },
  { x: "95%", y: "85%", size: 48, rotate: -25 },
  { x: "12%", y: "94%", size: 44, rotate: 8 },
  { x: "38%", y: "92%", size: 60, rotate: -15 },
  { x: "62%", y: "96%", size: 52, rotate: 22 },
  { x: "85%", y: "94%", size: 56, rotate: -8 },
];
