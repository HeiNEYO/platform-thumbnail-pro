        ...
        <div className="w-full lg:w-[48%] min-h-screen bg-[#0d0d0d] flex flex-col p-8 lg:p-12">
          ...
          <div className="flex-1 flex items-center justify-center py-12">
            <div className="w-full max-w-[400px]">
              <h1 className="text-3xl lg:text-4xl font-bold text-white mb-2">Lien invalide ou expiré</h1>
              <p className="text-white/60 text-sm lg:text-base mb-8">
                Ce lien de réinitialisation n&apos;est plus valide. Demandez un nouveau lien en cliquant ci-dessous.
              </p>
              <Link
                href="/forgot-password"
                className="inline-flex items-center gap-2 py-4 px-6 rounded-xl border-biseau-top-primary bg-primary hover:bg-primary-hover text-white font-semibold transition-all"
              >
