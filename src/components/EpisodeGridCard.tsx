    ...
    <div className="space-y-5">
      ...
      >
        ...
        <div className="relative w-full h-full bg-gradient-to-br from-[#1D4ED8]/20 to-[#0a0a0a]">
          {/* Placeholder pour la miniature - à remplacer par thumbnail_url quand disponible */}
      ...
      <div className="flex justify-around">
        ...
        <div className="text-center">
          ...
          <div className="text-sm text-[#999999] font-normal">Durée</div>
        </div>
        ...
        <div className="text-center">
          ...
          <div className="text-sm text-[#999999] font-normal">Progrès</div>
        </div>
      </div>
