-- ============================================
-- FORMATION THUMBNAIL PRO - Modules et Épisodes Finaux
-- ============================================
-- À exécuter dans Supabase : SQL Editor → New query → Coller → Run
--
-- Ce script crée les 5 modules avec leurs épisodes exacts selon la liste fournie
-- ============================================
...
VALUES (
  gen_random_uuid(),
  'Introduction Thumbnail Pro',
  'Introduction à la formation Thumbnail Pro',
  0,
  NULL,
...
DO $$
DECLARE
  module_intro_id uuid;
BEGIN
  SELECT id INTO module_intro_id FROM public.modules WHERE title = 'Introduction Thumbnail Pro' LIMIT 1;
  
  INSERT INTO public.episodes (module_id, title, duration, order_index, video_url) VALUES
    (module_intro_id, '1 · Introduction', NULL, 1, NULL),
    (module_intro_id, '2 · Rejoindre le discord', NULL, 2, NULL),
    (module_intro_id, '3 · Installer Photoshop', NULL, 3, NULL)
  ON CONFLICT DO NOTHING;
END $$;
...
BEGIN
  ...
  INSERT INTO public.episodes (module_id, title, duration, order_index, video_url) VALUES
    (module_1_id, 'Outils Déplacements', NULL, 1, NULL),
    (module_1_id, 'Sélectionneur de forme', NULL, 2, NULL),
    (module_1_id, 'Outils Lassos', NULL, 3, NULL),
    (module_1_id, 'Outils Baguette/Sélection', NULL, 4, NULL),
    (module_1_id, 'Outils de Recadrage', NULL, 5, NULL),
    (module_1_id, 'Pipette', NULL, 6, NULL),
    (module_1_id, 'Outils Correcteur', NULL, 7, NULL),
    (module_1_id, 'Outils Pinceau & Gomme', NULL, 8, NULL),
    (module_1_id, 'Outils Doigt', NULL, 9, NULL),
    (module_1_id, 'Outils Plumes', NULL, 10, NULL),
    (module_1_id, 'Outils Textes', NULL, 11, NULL),
    (module_1_id, 'Outils de formes', NULL, 12, NULL)
  ON CONFLICT DO NOTHING;
END $$;
