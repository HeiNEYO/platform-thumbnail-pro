-- ============================================
-- FORMATION THUMBNAIL PRO - Modules Organisés
-- ============================================
-- À exécuter dans Supabase : SQL Editor → New query → Coller → Run
--
-- Ce script crée tous les modules de la formation Thumbnail Pro avec leurs épisodes
-- organisés comme dans les screenshots
-- ============================================
...
DECLARE
  module_0_id uuid;
BEGIN
  SELECT id INTO module_0_id FROM public.modules WHERE title = 'Introduction Thumbnail Pro' LIMIT 1;
  
  INSERT INTO public.episodes (module_id, title, duration, order_index, video_url) VALUES
    (module_0_id, '1. Introduction', NULL, 1, NULL),
    (module_0_id, '2. Rejoindre le discord', NULL, 2, NULL),
    (module_0_id, '3. Installer Photoshop', NULL, 3, NULL)
  ON CONFLICT DO NOTHING;
END $$;
