        ...
        headers: [
          {
            ...
            value: [
              ...
              "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://*.vimeo.com https://*.vimeocdn.com https://nominatim.openstreetmap.org https://*.tile.openstreetmap.org https://unpkg.com",
